...
#+begin_quote
*WARNING*: This package is currently under active development and will be
released for public usage soon. Until then, it might contain breaking changes.
#+end_quote
...
(use-package jal
  :ensure t
  :config
  (setq jal-additional-agents '(("my-custom-agent")))) ; Optional
...
(use-package jal
  :config
  (setq jal-additional-agents
        '(("my-agent" :jar-path "/opt/agents/my-agent.jar" :params "config=prod"))))
#+end_src
